...
for k = 1:(2*n)
    ...
    % To prevent eeglab's nested console output from spamming the console
    % it is wrapped in an evalc
    [trash, h] = evalc("topoplot(WA(:,col_idx(k))./m,'channel_locations.loc');");
