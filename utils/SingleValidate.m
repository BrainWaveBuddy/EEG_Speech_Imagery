function [TP,FP,TN,FN,W,X,Y,T,AUC,CM] = SingleValidate(trainData,testData,lag,eSz,Warg)
...
%% Check prediction model - Skip ROC computation if output is not requested
if nargout > 5
    % Get ROC curves
    nFeat2 = size(y3,1);
