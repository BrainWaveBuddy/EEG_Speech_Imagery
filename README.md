...
<img src="plotsAndFigures/topoplots/topoplot_1.jpg" alt="Topoplot 1" width="500">
...
<div style="display: flex; align-items: flex-start; gap: 15px;">
  ...
  <div style="flex: 0 0 50%; max-width: 50%;">
    <img src="plotsAndFigures/periodograms1.jpg" alt="Power Spectral Density" style="width: 100%; height: auto;">
  </div>
</div>
